...
In this lab you will practice MySQL Subqueries, Temp Tables, and Action Queries. **You will use the `publications` database**. You can find it [here](https://drive.google.com/file/d/16bN54DK04IUxEtUKy_IMzrrmOfJOW3Fw/view?usp=sharing).

Create a `solutions.sql` file in the `your_code` directory to record your solutions to all challenges.
