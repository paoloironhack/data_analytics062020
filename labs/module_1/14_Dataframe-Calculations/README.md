...
* `challenge-1.ipynb`, `challenge-2.ipynb` and `challenge-3.ipynb` are challenges that will help you acquire the basics of dataframe calculation and transformation. 
